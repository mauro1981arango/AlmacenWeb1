<%-- 
    Document   : index
    Created on : 3/03/2022, 11:37:57 a. m.
    Author     : Diego Arango
--%>
                ...
                <div class = "card-body">
                    <form class="form-sign" action="Validar" method="post">
                        <div class = "form-group text-center">
                            ...
                            <label>Bienvenidos al Sistema de Ventas Web</label>
                        </div> 
                        ...
                        <input type="submit" name="accion" value="Ingresar"class="btn btn-primary" class="btn block">
                    </form>
                </div>
            </div>
        </div>
